...
- `docs/archive/ecad2-t033-implementation-plan-samurai.md`5節（忍者検証観点）
- `docs/archive/ecad2-t033-review-onmitsu-2.md`（増分1再レビュー、往復1周目クリーン）
- `docs/archive/ecad2-t021-increment-v-review-340f53d-onmitsu.md`（クランプ・座標変換の教訓参照元）
