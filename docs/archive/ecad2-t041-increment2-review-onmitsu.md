...
`docs/archive/ecad2-t041-key-flow-proposal-samurai.md`3節と照合：始点＝`SelectedCell`（行・整数列境界）、
...
- `docs/archive/ecad2-t041-key-flow-proposal-samurai.md`（3節、キー操作フロー原案）
- `docs/archive/ecad2-t041-increment1-review-onmitsu.md`・`-2.md`（所見A/B、状態管理集約の経緯）
