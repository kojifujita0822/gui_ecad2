...
対象: コミット`8b1b734`（隠密レビュー`docs/archive/ecad2-t051-review-onmitsu.md`#1〜#4対応）。テスト設計書=
`docs/archive/ecad2-t051-bugfix-test-design-onmitsu.md`。家老指定4観点の手動確認＋`code-review`スキル
...
殿裁定2026-07-11**）」と明言している。設計書`docs/archive/ecad2-t051-implementation-plan-samurai.md`93行目・
...
ではない。**隠密自身のT-051初回レビュー（`docs/archive/ecad2-t051-review-onmitsu.md`観点(d)「範囲自体はOK、
...
には忍者の実機確認が必要（`docs/archive/ecad2-t051-bugfix-test-design-onmitsu.md`§3.2が挙げた確認観点
...
## 出典
- `docs/archive/ecad2-t051-review-onmitsu.md`（今回の起点、指摘#1〜#4）
- `docs/archive/ecad2-t051-bugfix-test-design-onmitsu.md`（テスト設計、§3.2の忍者確認事項）
