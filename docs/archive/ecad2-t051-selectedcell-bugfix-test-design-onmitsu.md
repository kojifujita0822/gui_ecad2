...
家老采配（2026-07-11、隠密再レビュー`docs/ecad2-t051-round2-review-onmitsu.md`§2-1のCONFIRMED
...
（`docs/ecad2-t051-implementation-plan-samurai.md` 93/147行）は「SelectedCell/Tool状態/
...
## 出典
- `docs/ecad2-t051-round2-review-onmitsu.md`（§2-1、CONFIRMEDの詳細・混入時期の特定）
- `docs/ecad2-t051-implementation-plan-samurai.md`（93行目・147行目「開かれた論点1」）
- `docs/ecad2-t055-increment3-selectedcell-bugfix-test-design-onmitsu.md`（DeleteRowAtCommandの
