...
> 2026-07-11 隠密調査。往復3周超え案件（T-051）クローズ時の掟（`docs/archive/ecad2-t050-stryker-review-onmitsu.md`
...
`docs/ecad2-t046-stryker-survey-onmitsu.md`（2026-07-08）・`docs/archive/ecad2-t050-stryker-review-onmitsu.md`
...
- `docs/archive/ecad2-t050-stryker-review-onmitsu.md`（同上、往復2周超えクローズ時の制度の出典）
