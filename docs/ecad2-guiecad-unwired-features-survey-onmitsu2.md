...
殿直接指示（実装要否判断の材料）。`docs/ecad2-ui-ux-inventory.md`（忍者、2026-07-03）を出発点に、
...
| 20 | グリッド表示切替 | App（表示メニューのトグル） | **A** | — | T-056として隠密2が別途調査済み（`docs/ecad2-t056-grid-toggle-proposals-onmitsu2.md`）。**本セッション中に侍が実装しA区分へ到達したことを実物で確認**（`IsGridVisible`、`MainWindow.xaml:130`） |
...
- `docs/ecad2-ui-ux-inventory.md`（忍者、2026-07-03、出発点）
- `docs/ecad2-t060-pdf-ui-wiring-survey-onmitsu2.md`・`docs/ecad2-t061-testmode-ui-wiring-survey-onmitsu2.md`・
  `docs/ecad2-t056-grid-toggle-proposals-onmitsu2.md`（本セッション既実施分）
