...
の実装自体は、侍の実装プラン（`docs/ecad2-t041-implementation-plan-samurai.md`122-129行目「案A」）
...
発生した実績**を踏まえると、実装プラン（`ecad2-t041-implementation-plan-samurai.md`）が予告する
...
- `docs/ecad2-t041-implementation-plan-samurai.md`（122-129行目、案Aの意図・忍者検証観点）
