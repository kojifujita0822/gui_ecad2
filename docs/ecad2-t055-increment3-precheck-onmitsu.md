...
家老采配（2026-07-10）を受けての事前調査。計画書 `docs/ecad2-t055-implementation-plan-samurai.md` §1増分3の
...
増分1レビュー（`docs/ecad2-t055-increment1-review-onmitsu.md:84`）で「増分3で再利用できない一回限りの実装」と
申し送り済み。
...
計画書 `docs/ecad2-t055-implementation-plan-samurai.md:103` は「`GroupFrame.Height`は行数のため挿入/削除で
...
これは計画書 `docs/ecad2-t055-implementation-plan-samurai.md:109` の開かれた論点そのもの
...
2. 計画書 `docs/ecad2-t055-implementation-plan-samurai.md` §1増分3へ、GroupFrame内部挿入・削除時の
   Height伸縮規則（§2.3）を追記
