...
## T-099(c) 上段AnchorablePaneTitle表示制御——長期調査、案Y設計完了・実装は次回セッション
...
### T-103 配置ツールバー、独自ドロップ枠方式によるドッキング操作の確実化 — Approved（gated、殿直接指示2026-07-19）
...
### T-104 配置ツールバー、タブストリップに「基本機能」「配置ツール」を切替表示 — Approved（gated、殿直接指示2026-07-19）
...
**残る未着手＝矢印キー移動対応**（殿裁定待ちのまま未着手、832-871行参照）。T-067はこれにて
(1)〜(5)本体が実質完了。
