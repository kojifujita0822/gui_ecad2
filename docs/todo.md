...
### T-126 保存時クランプによる接続点重複の防止（P-129）＋v0.5.1リリース — Approved（gated、殿裁可2026-07-27、**T-125に優先**）
...
**残るはv0.5.1リリースのみ**。**殿裁定2026-07-27＝T-128も含めて一度に出す**ゆえ、T-128および上記
文言修正の決着後に侍が実施する（手順はT-124と同一）。

### T-129 実機確認の手順・UI Automation基盤の見直し — Approved（gated、殿直接指示2026-07-27）
...
### T-128 「既定レイアウトに戻す」機能の新設 — Approved（gated、殿直接指示2026-07-27）
