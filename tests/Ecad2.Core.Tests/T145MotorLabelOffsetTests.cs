...
/// </para>
/// <para>
/// <b>【測っておらぬこと】</b>実機での見え方——とりわけ<b>文字の中心が円の中心と目で見て合うか</b>は
/// 測れておらぬ。<c>Coil</c> は理論値 -5.5 から -5.72 へ、テキスト中心が円中心より約0.22mm上へ
/// ずれる分を忍者の実機実測で補正した前例がある（<c>ElementCatalog</c> のコメント）。
/// <b>本タスクでは理論値のみを入れてある</b>——同じ描画系ゆえ同型のずれが出る見込みだが、
/// 値まで同じとは限らぬゆえ、<b>実機の画素採取で確かめて頂く</b>。
/// </para>
/// </summary>
